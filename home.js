...
function iphone() {
    let listiphone = document.getElementById('iphone');
    listiphone.innerHTML = '';
    
    for (const iphone of products) {
       if(iphone.brand==='iphone'){
        let info = `
      <div class="content">
            <div class="content-img">
                <img src="${iphone.img}" alt=""  width="240px" height="240px">
            </div>
            <div class="content-name">
                <h4>
                ${iphone.name}
...
function oppo() {
    let listiphone = document.getElementById('oppo');
    listiphone.innerHTML = '';
    ...
    for (const phone of products) {
      ...
      <div class="content">
            <div class="content-img">
                <img src="${phone.img}" alt=""  width="240px" height="240px">
            </div>
            <div class="content-name">
                <h4>
                ${phone.name}
...
function samsung() {
    let listiphone = document.getElementById('samsung');
    listiphone.innerHTML = '';
